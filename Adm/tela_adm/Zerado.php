...
<div id="mySidenav" class="sidenav">
        ...
        <table>
            ...
            // Consulta para recuperar os dados da tabela com quantidade zero
            $sql = "SELECT idProd, tipoAlimento, nomeAlimento, preço_lote, preço_cliente, quantidade, validade, idCant FROM Produtos WHERE quantidade = 0";
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='7'>Nenhum produto com estoque zerado.</td></tr>";
            }
